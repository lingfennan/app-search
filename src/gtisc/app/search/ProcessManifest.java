...
import gtisc.app.search.axml.AXmlAttribute;
import gtisc.app.search.axml.AXmlHandler;
import gtisc.app.search.axml.AXmlNode;
import gtisc.app.search.axml.ApkHandler;
...
public class ProcessManifest {
	...
	// Permissions
	protected List<AXmlNode> permissions = null;
	...
	protected void handle(InputStream manifestIS) throws IOException, XmlPullParserException {
		...
		// Get permissions
		this.permissions = this.axml.getNodesWithTag("uses-permission");
	}
	...
	public ArrayList<String> getActivityNames() {
		...
		for (AXmlNode aXmlNode : this.activities) {
	...
	public ArrayList<String> getReceiverNames() {
		...
		for (AXmlNode aXmlNode : this.receivers) {
			AXmlAttribute<?> nameAttr = aXmlNode.getAttribute("name");
			if (nameAttr != null) {
				String name = (String) nameAttr.getValue();
	...
	public ArrayList<String> getProviderNames() {
		...
		for (AXmlNode aXmlNode : this.providers) {
			AXmlAttribute<?> nameAttr = aXmlNode.getAttribute("name");
			if (nameAttr != null) {
				String name = (String) nameAttr.getValue();
	...
	public ArrayList<String> getServiceNames() {
		...
		for (AXmlNode aXmlNode : this.services) {
			AXmlAttribute<?> nameAttr = aXmlNode.getAttribute("name");
			if (nameAttr != null) {
				String name = (String) nameAttr.getValue();
	...
	protected AXmlNode getNodeWithName(List<AXmlNode> list, String name) {
		for (AXmlNode node : list) {
			AXmlAttribute<?> nameAttr = node.getAttribute("name");
			if (nameAttr != null) {
				String nameStr = (String) nameAttr.getValue();
